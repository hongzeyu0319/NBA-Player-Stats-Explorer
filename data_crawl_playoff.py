'''Crawling and scraping multiple years of NBA playoff player stats'''
import json
from selenium import webdriver
from selenium.common.exceptions import NoSuchElementException
from bs4 import BeautifulSoup

def get_playoff_stats(season):
    """
    Get the Per Game Stats table for the playoffs of a given NBA season and return the stats as a list of dictionaries.
    ...
    cache_file_name = f'playoff_data/nba_{season}_playoff_stats_cache.html'
    ...
    # Find the Per Game Playoff Stats table
...
for season in range(start_season, end_season + 1):
    player_stats = get_playoff_stats(season)

    # Save the stats to a JSON file
    with open(f'playoff_data/nba_{season}_playoff_stats_cache.json', 'w', encoding='utf-8') as json_file:
